...
# Performs the Turing test 
# It uses the file test_10x10_1 which contains the database of 
# tweets used for testing (is pre-generated, but can be re-generated by ntlk_ver.py)
# It prints some tweets to the user, gets inpu and then stores the test result in the file results.py
